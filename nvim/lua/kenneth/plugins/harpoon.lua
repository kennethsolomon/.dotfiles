return {
    ...
    config = function()
        ...
        -- vim.keymap.set("n", "<C-r>", function() harpoon:list():select(4) end) -- No need for this
        ...
        vim.keymap.set("n", "<C-b>", function() toggle_telescope(harpoon:list()) end, { desc = "Open harpoon window" })
    end
}
